...
from ahorcado_diagramas import visual
...
def ahorcado():
    ...
    letras_por_adivinar = set(palabra)  # conjunto de letras de la palabra que deben ser adivinadas. en un conjunto no se guardan palabras repetidas
    ...
    while len(letras_por_adivinar) > 0 and vidas > 0:
        ...
        print(visual[vidas]) # mostrar estado del ahorcado.
